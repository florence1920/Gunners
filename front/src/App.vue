...
<style>
/* reset */
*, a, div, p, ul, li, section, body, input {list-style: none; text-decoration: none; margin: 0; padding: 0; box-sizing: border-box;}
...
/* basic layout */
.wrapAll {overflow: hidden; width: 100%; min-height: calc(100vh - 354px); position: relative;}
